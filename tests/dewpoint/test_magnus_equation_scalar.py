...
def get_metpy_dewpoint(temp_k, rh):
    ...
    try:
        td_c = dewpoint_from_relative_humidity(
            temp_c * units.degC, rh * units.dimensionless
        ).magnitude
...
class TestMagnusEquationBasic:
    ...
    def test_returns_float(self):
        ...
        result = _magnus_equation_scalar(293.15, 0.5, MAGNUS_WATER_A, MAGNUS_WATER_B)
    ...
    def test_dewpoint_less_than_temperature(self):
        ...
        for temp_k in temps:
            for rh in rhs:
                td = _magnus_equation_scalar(temp_k, rh, MAGNUS_WATER_A, MAGNUS_WATER_B)
                assert td <= temp_k, (
    ...
    def test_rh_100_percent_equals_temperature(self):
        ...
        for temp_k in temps:
            td = _magnus_equation_scalar(temp_k, 1.0, MAGNUS_WATER_A, MAGNUS_WATER_B)
    ...
    def test_valid_temperature_range(self):
        ...
        for temp_c in temps_c:
            ...
            td = _magnus_equation_scalar(temp_k, 0.6, MAGNUS_WATER_A, MAGNUS_WATER_B)
...
class TestMagnusEquationNOAA:
    ...
    def test_noaa_reference_values(self, temp_c, rh_percent, expected_td_c):
        ...
        td_k = _magnus_equation_scalar(temp_k, rh, MAGNUS_WATER_A, MAGNUS_WATER_B)
        ...
        for temp_c in [20, 25, 30, 35]:
            for rh in [0.5, 0.7]:
                ...
                td_k = _magnus_equation_scalar(
                    temp_k, rh, MAGNUS_WATER_A, MAGNUS_WATER_B
                )
                td_k_ref = get_psychrolib_dewpoint(temp_k, rh)
...
class TestMagnusEquationIceVsWater:
    ...
    def test_frostpoint_lower_than_dewpoint(self, temp_c, rh):
        ...
        # Dew point (water)
        td_water = _magnus_equation_scalar(temp_k, rh, MAGNUS_WATER_A, MAGNUS_WATER_B)

        # Frost point (ice)
        tf_ice = _magnus_equation_scalar(temp_k, rh, MAGNUS_ICE_A, MAGNUS_ICE_B)
...
class TestMagnusEquationEdgeCases:
    ...
    def test_freezing_point(self):
        ...
        td_ice = _magnus_equation_scalar(temp_k, rh, MAGNUS_ICE_A, MAGNUS_ICE_B)
    ...
    def test_cold_conditions(self):
        ...
        td_k = _magnus_equation_scalar(temp_k, rh, MAGNUS_ICE_A, MAGNUS_ICE_B)
...
class TestMagnusVsBuck:
    ...
    def test_magnus_vs_buck_difference(self, temp_c, rh):
        ...
        # Magnus (2 constants)
        td_magnus = _magnus_equation_scalar(temp_k, rh, MAGNUS_WATER_A, MAGNUS_WATER_B)
