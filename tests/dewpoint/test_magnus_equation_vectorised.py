...
class TestMagnusVectorizedCorrectness:
    ...
    def test_matches_scalar_single_value(self):
        ...
        result_scalar = _magnus_equation_scalar(
            temp_k[0], rh[0], MAGNUS_WATER_A, MAGNUS_WATER_B
        )
    ...
    def test_matches_scalar_multiple_values(self):
        ...
        result_vec = _magnus_equation_vectorised(
            temps_k, rhs, MAGNUS_WATER_A, MAGNUS_WATER_B
        )
    ...
    def test_matches_scalar_large_array(self):
        ...
        for i in indices:
            result_scalar = _magnus_equation_scalar(
                temps_k[i], rhs[i], MAGNUS_WATER_A, MAGNUS_WATER_B
            )
    ...
    def test_ice_constants_match_scalar(self):
        ...
        result_vec = _magnus_equation_vectorised(
            temps_k, rhs, MAGNUS_ICE_A, MAGNUS_ICE_B
        )
...
class TestMagnusVectorizedPhysics:
    ...
    def test_dewpoint_less_than_temperature(self):
        ...
        assert np.all(dewpoints <= temps_k), "All dew points must be ≤ temperature"
...
class TestMagnusVectorizedPerformance:
    ...
    def test_faster_than_scalar_loop(self):
        ...
        _ = _magnus_equation_vectorised(
            temps_k[:100], rhs[:100], MAGNUS_WATER_A, MAGNUS_WATER_B
        )
        _ = [
            _magnus_equation_scalar(t, r, MAGNUS_WATER_A, MAGNUS_WATER_B)
        ...
        assert speedup > 2.0, (
            f"Vectorized should be >2x faster than loop. Got {speedup:.1f}x speedup"
        )
    ...
    def test_vectorization_performance(self):
        ...
        for n in sizes:
            ...
            if n == sizes[0]:
                for _ in range(5):
                    _ = _magnus_equation_vectorised(
                        temps, rhs, MAGNUS_WATER_A, MAGNUS_WATER_B
                    )
    ...
    def test_parallel_performance(self):
        ...
        # Warmup
        for _ in range(5):
            _ = _magnus_equation_vectorised(temps, rhs, MAGNUS_WATER_A, MAGNUS_WATER_B)
...
class TestMagnusVectorizedMemory:
    ...
    def test_memory_efficient(self):
        ...
        # Run function
        result = _magnus_equation_vectorised(temps, rhs, MAGNUS_WATER_A, MAGNUS_WATER_B)
...
class TestMagnusVectorizedStability:
    ...
    def test_deterministic(self):
        ...
        assert_array_equal(result1, result2, err_msg="Results should be identical")
