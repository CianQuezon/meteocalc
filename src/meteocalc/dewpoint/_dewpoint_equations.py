...
class DewPointEquation(ABC):
    ...
    def _validate_input(self, temp_k: Union[float, npt.ArrayLike], rh: Union[float, npt.ArrayLike]) -> tuple[npt.NDArray, npt.NDArray]:
        """
    ...
    def calculate(self, temp_k: Union[float, npt.ArrayLike],
                  rh: Union[float, npt.ArrayLike]) -> Union[float, npt.NDArray]:
        """
