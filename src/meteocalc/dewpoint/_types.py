...
from meteocalc.dewpoint._dewpoint_equations import MagnusDewpointEquation, VaporInversionDewpoint

APPROXIMATION_DEWPOINT_REGISTRY = {
    DewPointEquationName.MAGNUS: MagnusDewpointEquation
}
